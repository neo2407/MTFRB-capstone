                        ...
                        <div class="list-btn">
                          ...
                          <!-- <div class="dropdown">
                           Send Renewal Reminder Button
                            ...
                            // Function to send SMS based on the selected month
                        // Function to send SMS based on the selected month
                            function sendSms() {
                                ...
                                if (!month) {
                                    Swal.fire({
                                        ...
                                        text: 'Please select a month to send SMS.'
                                    });
                                    return;
                                }
                        
                                fetch('sendBulksms-infobip.php', {
                                    method: 'POST',
                                ...
                                .then(data => {
                                    if (data.success) {
                                        Swal.fire({
                                            icon: 'success',
                                            title: 'SMS Sent!',
                                            text: 'SMS sent successfully to all operators.'
                                        });
                                    } else {
                                        Swal.fire({
                                            icon: 'error',
                           ...
                           <!-- <script>
                                ...
                                function sendSms() {
                                    ...
                                    // Example AJAX call to send SMS for all operators in the selected month
                                    fetch('sendBulksms-twilio.php', {
                                        method: 'POST',
                                        headers: { 'Content-Type': 'application/json' },
                                        body: JSON.stringify({ month: month })
                                    })
                                    ...
                                    .then(data => {
                                        if (data.success) {
                                            ...
                                            Swal.fire({
                                                icon: 'error',
                                                title: 'Failed to Send SMS',
                                                text: 'There was an issue sending SMS to operators.'
                                            });
                                        }
                                    })
                                    .catch(error => {
