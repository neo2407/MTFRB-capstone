...
?>
                    ...
                    <div class="row">
                        ...
                        <div class="card border-left-info shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Franchise Applicants</div>
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-auto">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <script>
            // Detect when the user closes or refreshes the browser/tab
        window.addEventListener("beforeunload", function () {
            // Use navigator.sendBeacon to ensure the logout request is sent
            navigator.sendBeacon('record_logout.php');
        });
        </script>
