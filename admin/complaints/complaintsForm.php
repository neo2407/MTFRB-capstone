  ...
  <nav class="navbar navbar-light justify-content-flex margin-left=10px fs-3 mb-5 custom-nav">
   ...
   <div class="container">
      ...
      <div class="container d-flex justify-content-center">
         <form action="complaintsUser.php" method="post" enctype="multipart/form-data" style="width:50vw; min-width:300px;">
            <div class="row mb-3">
            ...
            <div class="row mb-3">
               ...
               <div class="col">
                  ...
                  <input type="text" class="form-control" name="contactNum" placeholder="09xx xxx xxxx"  required>
               </div>
            ...
            <div class="row mb-3">
               ...
               <input type="text" class="form-control" name="descOfincident" placeholder="Type your complaint here">
              </div>
            </div>
            <br>
            <div class="row mb-3">
               ...
               <input type="text" class="form-control" name="colorOftric" placeholder="Type the color of ther tricycle">
              </div>
            ...
            <div class="row mb-3">
               <div class="col">
                  ...
                  <input type="text" class="form-control" name="descOfdriver" placeholder="Type the drivers description here">
               </div>
            ...
            <div class="row mb-3">
               ...
               <div  style="width: 400px; padding: 8px; font-size: 14px;">
                  ...
                  <input type="datetime-local" class="form-control" name="dtOfcontact" placeholder="Type the drivers description here">
               </div>

            <div>
               <button type="submit" class="btn btn-success" name="submit">Submit</button>
               <a href="apply.php" class="btn btn-danger">Cancel</a>
            </div>
         </form>
      </div>
   </div>
