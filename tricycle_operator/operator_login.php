<?php 
    ...
    include "operatorLog_functions.php";
...
<head>
    ...
    <title> Operator Login Form</title>
...
<form action="operator_login.php" method="POST" autocomplete="" style="border-radius: 1rem;">
            <div class="form-content text-center">
                 <img src="assets/img/MTFRB LOGO 2.png" class="Logo">
                <div class="mb-md-5 mt-md-4 pb-1">
                    <h2 class="fw-bold mb-2 text-uppercase">Tricycle Operator Login</h2>
...
<div>
<p class="fs-6">Don't Have a Tricycle Franchise? <a href="../franchise_applicant/account-registration.php" class="fw-bold">Apply Now</a>
</p>
</div>
