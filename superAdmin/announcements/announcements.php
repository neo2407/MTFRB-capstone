 ...
 <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div class="col-md-12"style="margin-left:20px">
        <h3 class="h3 mb-0 text-gray-800">Announcements</h3>
            <div class="page-wrapper" style="min-height: 548px; margin-left:-5px; ">
            <div class="content container-lg">
                    ...
                    <div class="content-page-header">
                        <div class="list-btn">
                            ...
                            <!--<li>
                                ...
                                <i class="fas fa-search" style="margin-right:10px;"></i>Search Account
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                            <a type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_announcement_Modal"
                                style="background-color: #2680C2; color: #fff; border: 1px solid #2680C2; box-shadow: inset 0 0 0 0 #fff; border-radius: 4px; transition: all 0.3s ease; margin-left:-45px;"
                                ...
                                <i class="fa fa-plus-circle me-2" aria-hidden="true"></i> Add Announcement
                                </a>
                                 </li>
                            </ul>
                        </div> 
                ...
                <div class="container-fluid" style="margin-left:-55px">
                    <div class="row">
                        <div class="col-sm-12">
