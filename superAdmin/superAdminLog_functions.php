...
if (isset($_POST['login'])) {
    ...
    if ($res->num_rows > 0) {
       $fetch = $res->fetch_assoc();
        ...
        } else if($account_type !== 'Super Admin'){
        $errors['email'] = "Your account type is not Super Admin, you do not have permission to login";
            ...
            header('Location: dashboard/superAdminDash.php');
            exit();
        } else {
