...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div class="col-md-12" style="margin-left:20px">
        <h3 class="h3 mb-0 text-gray-800">Previous Operators</h3>
                                    ...
                                    <div class="table-container">
                                        <div class="table-responsive">
                                            <table class="table table-hover text-center">
                                                ...
                                                <tbody id="table_body">
                                                    <!-- load franchise operator table
                                                    <script src = ../assets/js/load_previous_operator.js></script>-->
...
$('#printTableBtn').on('click', function() {
    ...
    printWindow.document.write('<h1>Previous Tricycle Operators</h1>');
