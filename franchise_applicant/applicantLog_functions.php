...
function sendEmail($recipient, $subject, $body) {
    ...
    try {
        ...
        $mail->Username   = 'mtfrblucban2024@gmail.com'; // SMTP username
        $mail->Password   = 'uway leyk zkah dcda'; // SMTP password
...
if (isset($_POST['login'])) {
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        if ($acc_status !== 'verified') {
            $errors['login'] = "Your account is currently Not Verified. Please enter the verification code sent your email upon account registration.";
        ...
        $errors['login'] = "It looks like you do not have an account to login! Click the Register button below to create an account.";
    }
