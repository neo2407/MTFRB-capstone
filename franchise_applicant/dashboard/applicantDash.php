...
<style>
  body {
    ...
    background-attachment: fixed; /* Prevent the background from resizing */
  
}
</style>
<!-- Profile 1 - Bootstrap Brain Component -->
<section class="py-3 py-md-5 py-xl-8" style="margin-top:20px;">

  <div class="container ">
    <h3 style="color: #f5f5f5; margin-left:10px; margin-top:50px;">APPLICANT PROFILE</h3>
            ...
            <ul class="nav nav-tabs" id="profileTab" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="status-tab" data-bs-toggle="tab" data-bs-target="#status-tab-pane"
                  type="button" role="tab" aria-controls="status-tab-pane" aria-selected="false">Application Status</button>
              </li>
            </ul>
                      ...
                      <form action="update_info.php" method="post" enctype="multipart/form-data">
                        <div class="editable-fields">
                          ...
                          <div class="form-group row">
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                              ...
                              <input type="text" class="form-control" name="age" value="<?php echo htmlspecialchars($row['age']) ?>" readonly>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <label class="form-label"><h6>Driver's License No.</h6></label>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <label class="form-label"><h6>Driver's License Classification.</h6></label>
                              <input type="text" class="form-control" name="license_class" value="<?php echo htmlspecialchars($row['license_class']) ?>" readonly>
                            </div>
                            <div class="col-md-6">
                              <label class="form-label"><h6>Driver's License Expiration</h6></label>
                              <input type="text" class="form-control" name="license_exp" value="<?php echo htmlspecialchars($row['license_exp']) ?>" readonly>
                            </div>
                    ...
                    <div class="card-header" style="background-color: #FFFFFF; padding: 2px; font-size: 14px;">
                                      ...
                                      <div class="col-md-10">
                                        <form action="update_requirements.php" method="post" enctype="multipart/form-data" style="width:40vw; min-width:300px;">
                                            ...
                                            <div class="table-responsive" style="margin-left:-40px;">
                                                <br>
                                              <p style="font-size: 17px;"><b>Primary Requirements</b></p>

                                              <table class="table mx-auto table-bordered" style="margin-top:-20px;">
                                                <br>
                                                      <thead>
                                                          <tr>
                                                              <th>File Name</th>
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                            <td>PSA or Voter's ID/Certification 
                                                            <br>
                                            ...
                                            <div class="table-responsive" style="margin-left:-40px;">
                                                 <br>
                                            <p style="font-size: 17px;"><b>Additional Requirements</b></p>
                                              <table class="table mx-auto table-bordered" style="margin-top:-10px;">
                                                      <thead>
                                                          <tr>
                                                              <th>File Name</th>
                                                              <th>View Attachment</th>
                        ...
                        <div class="container">
                          ...
                          <?php
                            if (!empty($row['interview_sched'])) {
                              ...
                              echo '<label>Interview schedule will be on ' . htmlspecialchars($row['interview_sched']) . 
                                  ' at the Lucban MTFRB Office, located on the 3rd floor of Lucban Municipal Hall.</label>';
                                  
                                  echo'<llabel> <i>Note: Bring original documents submitted during online application for verification.</i></label>';
                            } else {
                     ...
                     <div class="tab-pane fade" id="status-tab-pane" role="tabpanel" aria-labelledby="status-tab" tabindex="0">
                        ...
                        <div class="container">
                          <br>
                         <?php
                            if (!empty($row['applicantStatus'])) {
                                if ($row['applicantStatus'] === 'Pending') {
                                    // If the applicant status is Pending
                                    echo '<label>Status: Pending</label>';
                                    echo '<p>MTFRB staff is in the process of reviewing your application.</p>';
                                } elseif ($row['applicantStatus'] === 'Verified') {
                                    // If the applicant status is Verified
                                    if (!empty($row['interview_sched'])) {
                                        // If there is an interview schedule
                                        echo '<label>Status: Verified</label>';
                                        echo '<p>Interview schedule will be on ' . htmlspecialchars($row['interview_sched']) . 
                                             ' at the Lucban MTFRB Office, located on the 3rd floor of Lucban Municipal Hall.</p>';
                                        echo '<p><i>Note: Bring original documents submitted during online application for verification.</i></p>';
                                    } else {
                                        // If there is no interview schedule
                                        echo '<label>Status: Verified</label>';
                                        echo '<p>Interview schedule is pending.</p>';
                                    }
                                } elseif ($row['applicantStatus'] === 'Denied') {
                                    // If the applicant status is Denied
                                    echo '<label> Status: Denied</label>';
                                    echo '<p>Reason for Denial: ' . htmlspecialchars($row['reason_denial']) . '</p>';
                                }
                            }
                            ?>
                        </div>
