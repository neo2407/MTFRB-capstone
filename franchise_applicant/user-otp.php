<?php include "account_verification.php"; ?>
<?php 
...
<style>
   ...
   .input-box {
    position: relative;
        margin: 10px 0;
        padding-bottom: 40px; /* Add space for error message */
    }
    
    .toggle-password {
        position: absolute;
        right: 15px;
        top: 25px; /* Adjust to align with input field */
   ...
   @media screen and (max-width: 768px) {
    ...
    .form-text {
     ...
     .forgot-pass img.Logo {
        ...
        opacity: 0.1;
        width: 90%;
        height: 70%; /* Ensure the logo fills the entire height */
        top: 50%;
        left: 50%;
        transform: translate(-50%, -50%);
        pointer-events: none;
...
<div class="forgot-pass">
    <form action="user-otp.php" method="POST" autocomplete="off" style="border-radius: 1rem;">
            <div class="form-content text-center">
                            <img src="../assets/img/MTFRB LOGO 2.png" class="Logo">
                <div class="mb-md-5 mt-md-4 pb-1 text-center">
                    <h2 class="fw-bold mb-3 text-uppercase">Email Verification</h2>
            ...
            <button type="submit"  type="submit" name="check" value="Submit"  data-mdb-button-init data-mdb-ripple-init class="back-btn btn btn-lg">Submit</button>
