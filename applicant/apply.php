...
<body>
  <nav class="navbar navbar-light justify-content-flex margin-left=10px fs-3 mb-5 custom-nav">
     <b>MTFRB LUCBAN</b> 
     <ul class="nav-links justify-content-right" style="color: #ffffff;">
        <li><a href="applicantLogin.php" style="color: white;">Login</a></li>
     </ul>
  </nav>
   ...
   <div class="container">
      ...
      <div class="container d-flex justify-content-center">
         <form action="user-apply.php" method="post" enctype="multipart/form-data" style="width:50vw; min-width:300px;">
            <div class="row mb-3">
               <div class="col">
